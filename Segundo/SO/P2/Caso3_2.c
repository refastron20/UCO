...
#define	NProductor 100
#define NConsumidor 100 //si hay más consumidores que productores el programa se queda bloqueado ya que hay consumidores que esperan productos
#define N 5 //tamaño del bufer, este debe ser como mínimo del tamaño total de hilos en el problema ya que hubiera nada mas que dos huecos y hay
