...
int main (int argc, char* const* argv){
	...
	try {
	  ...
	  if(! cam.isOpened())
	  {
		...
		bool SaveImage;
		int contador = 0;
		std::string direccion = "//home//rafa//Escritorio//UCO//Tercero//FSIV//Practicas//P4//Calibrate//cam";
		std::stringstream Saveimgs;
		int key = 0;

		while(!frame.empty() and contador < nimg){
		...
		saveparams("//home//rafa//Escritorio//UCO//Tercero//FSIV//Practicas//P4//Calibrate//Datos_cam.yml",cameraMatrix,distCoeffs,
					rvecs,tvecs,rms);
