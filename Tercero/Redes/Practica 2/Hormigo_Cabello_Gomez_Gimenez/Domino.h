...
/*entrego las fichas del monton a cada jugador(!son punteros al mismo por eso no se puede borrar el monton)
	param 1: vector de estructuras ficha(debe ser el jugador1)
	param 2: vector de estructuras ficha(debe ser el jugador2)
	param 3: vector de estructuras ficha(debe ser el monton)
	devuelve: vacio
*/
...
*/
bool pasar_turno(struct mesa **m, struct ficha **jugador, struct ficha **monton);
