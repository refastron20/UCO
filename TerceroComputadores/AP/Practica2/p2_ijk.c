...
#define ITERACIONES_MATRICES 2000
...
int main (int argc, char *argv[]) {
	...
	double end_t_serie = clock();

	double total_t_serie = (end_t_serie - start_t_serie)/CLOCKS_PER_SEC;
	printf("C[0][0]: %f\n", Cserie[0][0] );
