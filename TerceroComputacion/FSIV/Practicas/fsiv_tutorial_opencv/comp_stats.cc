                                      ...
                                      std::valarray<double>& devs)
{
    ...
    CV_Assert( !img.empty() );
    CV_Assert( img.type() == CV_8UC3 );//el tipo es 8 bits, U sin signo, y C3 tres canales, con eso hacemos que sean pixeles con tres valores: RGB
        ...
        for (int col=0; col<img.cols; ++col)
            {
                ...
                const cv::Vec3b v = img.at<cv::Vec3b>(row, col);//Primero filas!!!!!!!!!!
